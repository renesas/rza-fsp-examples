...
4.  Hardware Connection:
    ...
    (2) Connect J1 on EK-RZ/A3M Board and J2 on PmodUSBUART with jump wire as follows.
        ...
        5 --- GND  <---------> GND
        6 --- VCC  <---------> +3.3V
    (3) Connect with PC through USB Type-microB Connector (J1) on PmodUSBUART.
    (4) Connect DEBUG1 on Board with PC through Cable USB A to USB C.