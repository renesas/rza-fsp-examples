...
void hal_entry(void)
{
    ...
    APP_PRINT("This EP utilizes PMOD ACL sensor as iic slave device\r\n");
    APP_PRINT("Upon successful initialization, MPU displays sensor axis data\r\n");
    APP_PRINT("If SDA line is kept in LOW by any error \r\n");
    APP_PRINT("Please input 1 on Terminal Emulator to Open bus.\r\n\r\n");
    ...
    while (true)
    {
        ...
        else
        {
            ...
            {
                APP_PRINT("\nSlave keep the SDA line in low level.\r\n");
...
static void scl_toggle(void)
{
        ...
        for(uint8_t i = 24; i  > 0 ; i--)
        {
            ...
            temp_iccr1 &= ~(uint32_t) R_RIIC0_ICCR1_SOWP_Msk;
            temp_iccr1 ^= (uint32_t) R_RIIC0_ICCR1_SCLO_Msk;
            temp_iccr1 ^= (uint32_t) R_RIIC0_ICCR1_SDAO_Msk;
