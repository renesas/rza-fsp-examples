...
3. Hardware Settings:
    ...
    (3) Connect PMOD1 on SMARC Carrier Board and PmodUSBUART with jump wire as follows.
		
        J2 (PmodUSBUART)       PMOD1 (SMARC Carrier Board)
        1 --- NC 
        2 --- RXD  <---------> 7 (SCI0_TXD)
        3 --- TXD  <---------> 8 (SCI0_RXD)
        4 --- NC
    ...
    (5) Connect PMOD0 PIN7-12 on SMARC Carrier Board and Pmod LED.
