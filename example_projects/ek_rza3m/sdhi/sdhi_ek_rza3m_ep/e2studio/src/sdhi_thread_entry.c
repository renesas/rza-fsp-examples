...
__attribute__((section("UNCACHED_BSS"), aligned(64))) static uint8_t g_write_data[BUFFER_SIZE];
__attribute__((section("UNCACHED_BSS"), aligned(64))) static uint8_t g_read_data[BUFFER_SIZE];
