...
1. Project Overview:
    ...
    On power up after establishing the connection of sensor with RZ/A3M board, it displays accelerometer axis data on
...
4. Hardware Connection:
    ...
    (2) Connect Pmod ACL and Board as follows.
        Pmod ACL has two on board connectors, J2 is used for I2C communication.

        J2 (Pmod ACL)                Pin Header J1 (Board)
        -------                        --------
        |Pin 1|---SCL  <--->  SDA1-----|Pin 2 |
        |Pin 2|---SDA  <--->  SCL1-----|Pin 4 |
        |Pin 3|---GND  <--->  GND------|Pin 39|
        |Pin 4|---VCC  <--->  +3.3V----|Pin 5 |
        -------                        --------
