...
void hal_entry(void)
{
    ...
    /* If no LEDs are available, print an error and halt. */
    ...
    while(true)
    {
        ...
        /* For every 3Sec. TeraTerm prints WDT refresh message.
         * This is done to avoid the continuous print message on TeraTerm*/
...
/*******************************************************************************************************************//**
 * This function is called to read user input from TeraTerm using Uart.
 * @brief    Read user input from TeraTerm. Handle the Error internally with Proper Message. Application handles the rest.
 * @param[IN]   None
